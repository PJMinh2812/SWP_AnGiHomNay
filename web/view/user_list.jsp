<%-- Document : user_list Created on : Jun 15, 2025, 3:19:40 PM Author : Admin
--%> <%@ page import="java.util.List,model.Users" %> <%@ taglib
    uri="jakarta.tags.core" prefix="c" %> <% List<Users> users = (List<Users>) request.getAttribute("users");%> <%@page contentType="text/html"
               pageEncoding="UTF-8"%>
    <!DOCTYPE html>
    <html lang="vi">
        <head>
                ...
                <section class="user-section container fade-in">
                    <div class="user-header">
                        ...
                        <form
                            ...
                            >
                            <input type="text" name="search" placeholder="Tìm theo email,
                                   tên hoặc SĐT" value="<%= request.getAttribute("search") != null
                        ? request.getAttribute("search") : ""%>" style="padding: 0.4rem
                                   1rem; border-radius: 6px; border: 1px solid #ccc; min-width:
                                   220px;" />
                            <button type="submit" class="export-btn" style="margin-top: 0">
                                Tìm kiếm
                            </button>
                        </form>
