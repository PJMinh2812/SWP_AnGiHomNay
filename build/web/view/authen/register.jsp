            ...
            <div class="auth-box fade-in">
                ...
                <form id="registerForm" class="auth-form" method="post" action="${pageContext.request.contextPath}/register">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <i class="fas fa-lock"></i>
                            <input type="password" id="confirmPassword" name="confirmPassword" required placeholder="Xác nhận mật khẩu" class="input-focus-animation">
                            <button type="button" class="toggle-password"><i class="fas fa-eye"></i></button>
                        </div>
                    </div>

                    <button type="submit" class="btn-primary btn-register-submit btn-hover-effect">Đăng ký</button>
                </form>
